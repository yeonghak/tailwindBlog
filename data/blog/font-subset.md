...
tags: ['字体', '压缩']
draft: false
summary: 如何压缩Webfont字体，减少字体文件大小
---
...
subset文件夹，glyphs.txt，需要压缩的字体都放在同一个文件夹中
...
```
pyftsubset NotoSansKR-Regular.woff --flavor="woff" --text-file=glyphs.txt --output-file=subset/NotoSansKR-Regular-subset.woff --with-zopfli --layout-features="*" --glyph-names --symbol-cmap --legacy-cmap --notdef-glyph --notdef-outline --recommended-glyphs  --name-legacy --drop-tables= --name-IDs="*" --name-languages="*"
```

### woff2字体压缩

```
pyftsubset NotoSansKR-Regular.woff2 --flavor="woff2" --text-file=glyphs.txt --output-file=subset/NotoSansKR-Regular-subset.woff2 --with-zopfli --layout-features="*" --glyph-names --symbol-cmap --legacy-cmap --notdef-glyph --notdef-outline --recommended-glyphs  --name-legacy --drop-tables= --name-IDs="*" --name-languages="*"
```
